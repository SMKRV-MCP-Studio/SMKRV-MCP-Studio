...
<Info>
  ...
  **Recommended** provides comfortable headroom for multiple connections, concurrent queries, and the ML-based prompt injection guard (DeBERTa ONNX model, ~180 MB).
</Info>
