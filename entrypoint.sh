...
# Ensure SSL/certbot directories exist and are writable by appuser (uid 1000)
mkdir -p /var/www/certbot /etc/letsencrypt /etc/nginx/conf.d
chown -R 1000:1000 /etc/nginx/conf.d /var/www/certbot /etc/letsencrypt
