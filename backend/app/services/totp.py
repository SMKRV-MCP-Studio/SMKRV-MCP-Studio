...
def generate_recovery_codes() -> list[str]:
    ...
    return [
        secrets.token_hex(_RECOVERY_CODE_LENGTH // 2).upper() for _ in range(_RECOVERY_CODE_COUNT)
    ]
...
def verify_and_consume_recovery_code(code: str, hashed_json: str) -> tuple[bool, str | None]:
