...
class Settings(BaseSettings):
    ...
    # --- SSRF protection ---
    allow_private_networks: bool = False  # allow connections to RFC 1918/loopback

    # --- Passthrough SQL ---
    allow_passthrough_sql: bool = False  # allow tools with raw SQL passthrough

    # --- Studio ports ---
    port: int = 3000  # Studio UI port
    ssl_port: int = 443  # Studio SSL port

    # --- GeoIP ---
    geoip_db_path: str = "/app/data/GeoLite2-Country.mmdb"
    maxmind_license_key: str = ""
    geoip_source: str = "generic"  # "generic" (P3TERX) or "maxmind"
    ...
    prompt_guard_ml_threads: int = 1  # ONNX intra-op thread count
