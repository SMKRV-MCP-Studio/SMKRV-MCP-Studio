...
# ---------------------------------------------------------------------------
# Internal agent-auth token exchange (backend ← agent-mcp communication)
# ---------------------------------------------------------------------------


class TokenExchangeRequest(BaseModel):
    """Body for /agent-auth/token endpoint (internal inter-service call).

    Extends public TokenRequest with client_ip and client_country fields
    passed by the agent-mcp container for usage tracking.
    """
